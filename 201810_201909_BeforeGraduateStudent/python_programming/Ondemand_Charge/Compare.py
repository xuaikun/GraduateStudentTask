...
if __name__ == "__main__":
    ...
    # 导入测试数据
    data = np.loadtxt(RCSS_ResponseTimeAndServiceTimeSimulation_list_txt)
    ...
    kedu_new = 500
    plt.plot(data[0],data[1], 'g:o',label = 'RespondTime')
    plt.plot(data[0], data[2],'b--*',label = 'ServiceTime')
